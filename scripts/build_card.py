...
try:
    ...
    prefs.compute_device_type='METAL' if sys.platform=='darwin' else 'OPTIX'; prefs.get_devices()
    gpu=False
...
# Compositor glow.
ct=bpy.data.node_groups.new('辉光合成','CompositorNodeTree')
...
# Preferences remain in this scene session; do not modify global defaults.
scene.frame_set(25)
